...
export function FinanceIconPicker({ value, onValueChange, compact = false }: { value: string; onValueChange: (value: string) => void; compact?: boolean }) {
  ...
  return <Popover open={open} onOpenChange={setOpen}>
    ...
    <PopoverContent align="start" collisionPadding={16} className="w-[min(360px,calc(100vw-2rem))] max-h-[min(76dvh,520px)] gap-3 overflow-hidden rounded-2xl p-3">
      ...
      <div className="mobile-scroll grid min-h-0 grid-cols-5 gap-2 overflow-y-auto pr-1 sm:grid-cols-6">
