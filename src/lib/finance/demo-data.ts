import type { FinanceState, Liability, LiabilityRatePeriod, LiabilityTerms } from "./types";

const today = "2026-08-17";
const demoCardLiability = {
  accountId: "acc-visa",
  kind: "credit_card",
  status: "active",
  creditorName: "Bancolombia",
  originalPrincipal: 410_000,
...
const demoCardTerms = {
  ...
  intervalCount: 1,
  calculationMethod: "statement_balance",
  ...
  periodicInsurance: 0,
  variableRate: false,
  prepaymentStrategy: "manual",
  source: "migration",
  version: 1,
} satisfies LiabilityTerms;
const demoCardRate = {
  id: "rate-visa-purchases",
  accountId: "acc-visa",
  rateKind: "purchase",
  rateBasis: "effective_annual",
  reportedValue: 24.5,
  effectiveAnnualRate: 24.5,
  startsOn: "2026-01-01",
  source: "migration",
} satisfies LiabilityRatePeriod;
...
export const demoFinanceState: FinanceState = {
  ...
  liabilities: [demoCardLiability],
  liabilityTerms: [demoCardTerms],
  liabilityRatePeriods: [demoCardRate],
  ...
  liabilityOverview: {
    ...
    totalReportingDebt: 868_000,
    items: [{
      liability: demoCardLiability,
      accountId: "acc-visa",
      accountVersion: 1,
      liabilityVersion: 1,
      name: "Visa terminada en 4242",
      accountName: "Visa terminada en 4242",
      kind: "credit_card",
      status: "active",
      creditorName: "Bancolombia",
      currencyCode: "COP",
      ...
      accountColor: "#60a5fa",
      icon: "brand:visa",
      accountIcon: "brand:visa",
      entityId: "entity-bancolombia",
      originalPrincipal: 410_000,
      originatedOn: "2026-01-01",
      migrationStatus: "native",
      nativeBalance: -868_000,
      nativeDebt: 868_000,
      reportingBalance: -868_000,
      reportingDebt: 868_000,
      reportingApproximate: false,
      currentTerms: demoCardTerms,
      currentRates: [demoCardRate],
      rates: [demoCardRate],
      card: {
        accountId: "acc-visa",
        network: "visa",
  ...
  recurringRules: [
    {
      ...
      exchangeRate: 1, exchangeRateDate: "2026-08-20", exchangeRateSource: "same_currency",
    ...
    },
    {
      ...
      exchangeRate: 1, exchangeRateDate: "2026-09-01", exchangeRateSource: "same_currency",
